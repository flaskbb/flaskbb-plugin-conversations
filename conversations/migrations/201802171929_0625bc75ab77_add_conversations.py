...
def upgrade():
    ...
    if not sa.inspect(con.engine).has_table("conversations"):
        op.create_table(
            "conversations",
            ...
            sa.ForeignKeyConstraint(
                ["from_user_id"],
                ["users.id"],
                name=op.f("fk_conversations_from_user_id_users"),
                ondelete="SET NULL",
            ),
            sa.ForeignKeyConstraint(
                ["to_user_id"],
                ["users.id"],
                name=op.f("fk_conversations_to_user_id_users"),
                ondelete="SET NULL",
            ),
            sa.ForeignKeyConstraint(
                ["user_id"],
